...
<div class="container">
        ...
        <div class="row">
   		...
   		<div class="row">
                    ...
                    <br>
 					<div class="col-lg-9">
                     <button  type="submit" class="btn btn-primary" name="incident-submit"  formation="/incidentMgmt.php">
                            <a href= "incidentMgmt.php" style="color:white;text-decoration:none"> Submit</a>
                           </button>

                           <button  type="cancel" class="btn btn-primary" name="incident-cancel" formation="/incidentMgmt.php">
