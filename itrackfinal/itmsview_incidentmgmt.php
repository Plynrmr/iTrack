...
<body>
 ...
 <div class = "col-md-4 offset-md-4">
                           ...
                           <button  type="cancel" id="cancelincident" class="btn btn-primary" formation="/homeitrack.php">
                            <a href= "includes/closeIncident.inc.php?id=<?=$id?>" style="color:white;text-decoration:none">Close Incident</a>
                            ...
                            <a href= "" style="color:white;text-decoration:none">Archive</a>
	 	...
	 	<div class="row">
          ...
          <div class="row">
					<div class = "col-8">
          <label for="shortDescription"> Summary Report </label>
